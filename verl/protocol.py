...
class DataProto:
    ...
    ### Two function from PRIMETrainer, only use in the RayPRIMETrainer.add_to_buffer function
    def buffer_slice(self, index):
    ...
    def buffer_slice_batch(self, start, length, dim=0):
        """
        Note that this operation is in-place
        """
