...
#     def __init__(
#         self, tokenizer, num_examine, compute_score: RawRewardFn, reward_fn_key="data_source", light_eval: bool = False, **reward_kwargs
#     ):
#         self.tokenizer = tokenizer
#         self.num_examine = num_examine
#         self.compute_score = compute_score
...
#         if return_dict:
#             return scores, {"reward_tensor": reward_tensor, "reward_extra_info": reward_extra_info}
#         else:
