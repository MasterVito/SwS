...
def load_reward_manager(
    config: DictConfig, tokenizer: Any, num_examine: int, validation: bool = False, **reward_kwargs: Any
    ...
    if validation and "light_eval" in reward_kwargs: 
        reward_kwargs["light_eval"] = False  # disable light_eval if validation is True
        print(f">>> Enabling {reward_manager_cls} reward manager.")
